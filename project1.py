...
def main():
    ...
    with consent:
        ...
        * I can withdraw at any time.
        """)
        consent_given = st.checkbox("I agree to the terms above.", value=False)
    ...
    with demographics:
        ...
        with st.form("demographic_form"):
            ...
            familiarity = st.selectbox("Familiarity with similar tools?", options=["",
                                                                                   "Not Familiar",
                                                                                   "Somewhat Familiar",
                                                                                   "Very Familiar"])
    ...
    with tasks:
        ...
        # Additional tasks to be added for later project
        ...
        if stop_button and "start_time" in st.session_state:
            ...
            del st.session_state["start_time"]  #Added to ensure multiple clicks of the stop button did not just add time

        """
        Placeholder for additional code to potentially include tasks built-in to the usability testing tool"
        """
